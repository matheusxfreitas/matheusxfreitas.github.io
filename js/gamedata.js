...
const GAMIFICATION_CONFIG = {
    ...
    items: [
        ...
        { id: 'bts_1', name: 'Sapatos de Couro', subject: 'Raciocínio Lógico-Matemático', tier: 1, imageUrl: 'assets/habitica-images-main/gear/armoire/shop/shop_shoes_rogue_1.png' },
        { id: 'bts_2', name: 'Botas de Ferro', subject: 'Raciocínio Lógico-Matemático', tier: 2, imageUrl: 'assets/habitica-images-main/gear/armoire/shop/shop_shoes_warrior_2.png' },
        { id: 'bts_3', name: 'Grevas de Aço', subject: 'Raciocínio Lógico-Matemático', tier: 3, imageUrl: 'assets/habitica-images-main/gear/armoire/shop/shop_shoes_warrior_3.png' }
    ],
    unlockThresholds: {
        TIER_1: 0.25,
        TIER_2: 0.50,
